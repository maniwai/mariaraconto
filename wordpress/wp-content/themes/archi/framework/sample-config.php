    ...
    Redux::set_section( $opt_name, array(
        ...
        'fields' => array( 
            ...
            array(
                ...
                'subtitle' => esc_html__('You must remove all of the background images are used in the inner pages before using this background color, (default color: #222222)', 'archi'),
                'default' => '#222222',
                'validate' => 'color',
            ), 
            array(
    ...
    Redux::set_section( $opt_name, array(
        ...
        'fields'     => array(     
            ...
            array(
                ...
                'subtitle' => esc_html__('Pick the Filter links active color for the theme (default: #111111).', 'archi'),
                'default' => '#111111',
                'validate' => 'color',
            ),
            array(
                ...
                'subtitle' => esc_html__('Pick the Filter links hover background color for the theme (default: #111111).', 'archi'),
                'default' => '#111111',
                'validate' => 'color',
            ),
            array(
                ...
                'subtitle' => esc_html__('Pick the Filter links active background color for the theme (default: #FAB207).', 'archi'),
                'default' => '#FAB207',
                'validate' => 'color',
            ),            
        )
