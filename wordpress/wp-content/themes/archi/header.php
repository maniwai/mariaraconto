...
<div id="wrapper">
    ...
    <?php if ( isset( $archi_option['topbar-allpage'] ) and $archi_option['topbar-allpage'] != false ) { ?>        
        <!-- top header begin -->
        <div class="info">
        ...
        <div class="<?php if ( isset( $archi_option['header-wideboxed'] ) and $archi_option['header-wideboxed'] != false ) { echo 'container-fluid'; } else { echo 'container'; } ?>">
            <div class="row">
                <div class="col-md-12">
                    <div id="logo">
                        <a href="<?php echo esc_url( home_url('/') ); ?>">
                            <img <?php if ( ! empty( $archi_option['logo_scroll']['url'] ) ) { ?>class="logo-static"<?php } ?> src="<?php echo esc_url( $archi_option['logo']['url'] ); ?>" alt="<?php bloginfo( 'name' ); ?>">
                            <?php if ( ! empty( $archi_option['logo_scroll']['url'] ) ) { ?>
                    ...
                    <nav>
                        <?php 
                            $menu_type_class = ''; 
                            if ( isset( $archi_option['menu_type'] ) and $archi_option['menu_type'] == 'dotted' ) { 
                                $menu_type_class = '';
                            } elseif ( isset( $archi_option['menu_type'] ) and $archi_option['menu_type'] == 'line' ) {
                                $menu_type_class = 'class="line-separator"';
                            } elseif ( isset( $archi_option['menu_type'] ) and $archi_option['menu_type'] == 'circle' ) {
                                $menu_type_class = 'class="circle-separator"';
                            } elseif ( isset( $archi_option['menu_type'] ) and $archi_option['menu_type'] == 'square' ) {
                                $menu_type_class = 'class="square-separator"';
                            } elseif ( isset( $archi_option['menu_type'] ) and $archi_option['menu_type'] == 'plus' ) {
                                $menu_type_class = 'class="plus-separator"';
                            } elseif ( isset( $archi_option['menu_type'] ) and $archi_option['menu_type'] == 'strip' ) {
